...
class HomeScreenDetailRedeemScreen
    extends GetView<HomeScreenDetailRedeemScreenController> {
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image:
                              NetworkImage(controller.promoModel.promoImageUrl),
                          fit: BoxFit.cover,
                        )),
                  ),
                  Positioned(
          ...
          child: SingleChildScrollView(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  controller.promoModel.promoImagesModel.isNotEmpty
                      ? SizedBox(
                          height: 80,
                          child: ListView.builder(
                              ...
                              itemCount:
                                  controller.promoModel.promoImagesModel.length,
                              itemBuilder: (BuildContext context, int index) {
                                return customRowCards(
                                    controller.promoModel
                                        .promoImagesModel[index].imageUrl,
                                    context);
                              }),
                        )
                      : const SizedBox(),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      // Text(
                      //   '(300)',
                      //   style: heading1(color: AppColors.a4Color, fontSize: 14),
                      // ),
                      Expanded(
                        child: Text(
                          controller.promoModel.address,
                          style:
                              heading1(color: AppColors.primary, fontSize: 15),
                        ),
                      ),
                      /*GestureDetector(
                          onTap: (){
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: heading1SemiBold(
                            color: AppColors.darkPink, fontSize: 14),
                      ),
                    ],
                  ),
                  const SizedBox(
                  ...
                  Row(
                    children: [
                      Expanded(
                          child: Text(
                        controller.promoModel.productName,
                        style: headingBold(color: AppColors.primary),
                      )),
                      Text(
                        '\$${controller.promoModel.price}',
                        style: headingBold(color: AppColors.primary),
                      ),
                    ],
                  ),
                  ...
                  Row(
                    children: [
                      Expanded(
                          child: Text(
                        controller.promoModel.userDetailModel.businessName,
                        style: bodyMediumMedium(
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      ...
                      children: [
                        for (int i = 0;
                            i < controller.promoModel.socialLinks.length;
                            i++)
                          socialMediaIconWidget(
                              platform:
                                  controller.promoModel.socialLinks[i].platform,
                              onPressed: () {
                                controller.openSocialLink(
                                    controller.promoModel.socialLinks[i].url);
                              }),
                      ],
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Promo Code',
                      style:
                          headingBold(color: AppColors.primary, fontSize: 14),
                    ),
                  ),
                  primaryButton(
                      color: AppColors.darkPink,
                      buttonText: controller.promoModel.promoCode,
                  ...
                  primaryButton(
                      ...
                      fontSize: 24,
                      onPressed: () {
                        Get.offAllNamed(kEditPromoScreen,
                            arguments: controller.promoModel);
                      }),
                ],
              ),
            ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Text(
            text,
            style: heading1SemiBold(color: AppColors.darkPink, fontSize: 20),
          )
        ],
      ),
    );
  ...
  Widget informationWidget() {
    return Column(
      ...
      children: [
        ...
        Text(controller.promoModel.description,
            style: bodyMediumMedium(color: AppColors.primary, fontSize: 15)),
        const SizedBox(
          height: 30,
        ),
      ],
      ...
      child: Row(
        ...
        children: [
          Expanded(
              child: Text(
            name,
            style: heading1SemiBold(color: AppColors.primary, fontSize: 14),
          )),
          Expanded(
              child: Text(
            value,
            style: heading1(
                color: AppColors.a4Color,
                fontSize: 14,
