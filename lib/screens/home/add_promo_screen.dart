...
class AddPromoScreen extends GetView<AddPromoScreenController> {
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            Text(
              'Add Promo',
              style: heading1SemiBold(fontSize: 20, color: AppColors.primary),
            ),
            SizedBox()
          ...
          child: Column(
            ...
            children: [
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          ...
                          style: heading1(
                              color: AppColors.requiredColor, fontSize: 12),
                        ),
                      ],
                    ),
                  ),
              ...
              Container(
                height: 170,
                width: Get.width,
                child: Obx(() => controller.photoImage.value.path != ''
                    ? Image.file(controller.photoImage.value, fit: BoxFit.cover)
                    : Image.asset(Img.get('upload_image.png'),
                        fit: BoxFit.cover)),
              ),
              Obx(
                () => Visibility(
              ...
              Obx(
                () => Container(
                    height: 70,
                    child: controller.listOfImages.isNotEmpty
                        ? Obx(
                            () => ListView.builder(
              ...
              Obx(
                () => Visibility(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.only(top: 10),
                    child: Text(
                      controller.additionalImagesErrMsg.value,
                ...
                children: [
                  ...
                  Obx(
                    () => Visibility(
                      ...
                      child: Text(
                        controller.productNameErrorMsg.value,
                        style: heading1(
                            color: AppColors.requiredColor, fontSize: 12),
                      ),
                    ),
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Obx(
                            () => Visibility(
                              ...
                              child: Text(
                                controller.priceErrorMsg.value,
                                style: heading1(
                      ...
                      Expanded(
                        ...
                        children: [
                          GestureDetector(
                            onTap: () {
                              if (!controller.priceValidation(
                                  controller.priceTEController.text)) {
                            ...
                            child: Obx(
                              () => formWidget(
                                  ...
                                  title: 'Discount',
                                  hint: controller.isPercentage.value
                                      ? "10%"
                                      : '\$500',
                                  textEditingController:
                                      controller.discountTEController),
                            ),
                          ),
                          Obx(
                            () => Visibility(
                              ...
                              child: Text(
                                controller.discountErrorMsg.value,
                                style: heading1(
                                    color: AppColors.requiredColor,
                                    fontSize: 12),
                              ),
                      ...
                      Expanded(
                        ...
                        children: [
                          formWidget(
                              ...
                              hint: '2023-01-01',
                              textEditingController:
                                  controller.discountStartTEController),
                          Obx(
                            () => Visibility(
                              visible:
                                  controller.discountStartErrorVisible.value,
                              child: Text(
                                controller.discountStartErrorMsg.value,
                                style: heading1(
                                    color: AppColors.requiredColor,
                                    fontSize: 12),
                              ),
                      ...
                      Expanded(
                        ...
                        children: [
                          formWidget(
                              ...
                              title: 'Discount Last Date',
                              hint: '2023-01-01',
                              textEditingController:
                                  controller.discountEndTEController),
                          Obx(
                            () => Visibility(
                              visible: controller.discountEndErrorVisible.value,
                              child: Text(
                                controller.discountEndErrorMsg.value,
                                style: heading1(
                                    color: AppColors.requiredColor,
                                    fontSize: 12),
                              ),
                  ...
                  descriptionContainer(
                      ...
                      textEditingController: controller.descriptionTEController,
                      onChanged: controller.descriptionValidation),
                  Obx(
                    () => Visibility(
                      visible: controller.descriptionErrorVisible.value,
                      child: Text(
                        controller.descriptionErrorMsg.value,
                        style: heading1(
                            color: AppColors.requiredColor, fontSize: 12),
                      ),
                    ),
                  ...
                  GestureDetector(
                      ...
                      child: Obx(() => formWidget(
                          ...
                          hint: '',
                          textEditingController:
                              controller.businessAddressTEController.value,
                          onChanged: controller.businessAddValidation))),
                  Obx(
                    () => Visibility(
                      visible: controller.businessAddressErrorVisible.value,
                      child: Text(
                        controller.businessAddressErrorMsg.value,
                        style: heading1(
                            color: AppColors.requiredColor, fontSize: 12),
                      ),
                    ),
                    ...
                    () => Visibility(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          ...
                          style:
                              heading1(color: AppColors.primary, fontSize: 12),
                        ),
                      ),
                    ),
                  ),
      ...
      child: Column(
        ...
        children: [
          ...
          customTextField(
              ...
              readOnly: title.contains('Discount Start Date') ||
                      title.contains('Discount Last Date')
                  ? true
                  : false,
              enabled:
                  title.contains('Promo Address') ? false : enabled ?? true,
              hintText: hint,
              suffixIcon: title.contains('Promo Address')
                  ? Icon(
                      Icons.location_on,
                      color: AppColors.darkPink,
                    )
                  : title == 'Discount'
                      ...
                      : title.contains('Discount Start Date') ||
                              title.contains('Discount Last Date')
                          ? GestureDetector(
                              onTap: () {
          ...
          Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle:
                    bodyMediumMedium(color: AppColors.secondary, fontSize: 18),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                        child: Text('Confirm Promo Location',
                            style: heading1(fontSize: 18))),
                    GestureDetector(
                        onTap: () async {
                        ...
                        child: Obx(
                          () => GoogleMap(
                            ...
                            initialCameraPosition: CameraPosition(
                              target: LatLng(controller.latLng!.latitude,
      ...
      () => Container(
        ...
        child: DropdownButtonHideUnderline(
          child: DropdownButton<CategoryModel>(
            ...
            items:
                controller.items.map<DropdownMenuItem<CategoryModel>>((value) {
  ...
  void chooseSocialLink() {
    showMessageDialogForSocialLink(type: DialogType.NO_HEADER);
  }
              ...
              Row(
                ...
                children: [
                  MaterialButton(
                    ...
                    onPressed: () {
                      if (controller.linkList.length < 9 &&
                          !controller.text.contains('facebook')) {
                        ...
                        CustomDialogs().showMessageDialog(
                            title: 'Alert',
                            description: 'facebook Link already added',
                            type: DialogType.INFO);
                      }
                    },
                    child: Image.asset(
                      Img.get('facebook_icon.png'),
                      height: 25,
                    ),
                  ),
                  MaterialButton(
                    ...
                    onPressed: () {
                      if (controller.linkList.length < 9 &&
                          !controller.text.contains('whatsapp')) {
                        ...
                        CustomDialogs().showMessageDialog(
                            title: 'Alert',
                            description: 'Whatsapp Link already added',
                            type: DialogType.INFO);
                      }
                    },
                    child: Image.asset(
                      Img.get('whatsapp_icon.png'),
                      height: 25,
                    ),
                  ),
                  MaterialButton(
                    ...
                    onPressed: () {
                      if (controller.linkList.length < 9 &&
                          !controller.text.contains('instagram')) {
                        ...
                        CustomDialogs().showMessageDialog(
                            title: 'Alert',
                            description: 'Instagram Link already added',
                            type: DialogType.INFO);
                      }
                    },
                    child: Image.asset(
                      Img.get('instagram.png'),
                      height: 25,
                    ),
                  ),
                ],
              ...
              Row(
                ...
                children: [
                  MaterialButton(
                    ...
                    onPressed: () {
                      if (controller.linkList.length < 9 &&
                          !controller.text.contains('youtube')) {
                        ...
                        CustomDialogs().showMessageDialog(
                            title: 'Alert',
                            description: 'youtube Link already added',
                            type: DialogType.INFO);
                      }
                    },
                  ...
                  MaterialButton(
                    ...
                    onPressed: () {
                      if (controller.linkList.length < 9 &&
                          !controller.text.contains('pinterest')) {
                        ...
                        CustomDialogs().showMessageDialog(
                            title: 'Alert',
                            description: 'pinterest Link already added',
                            type: DialogType.INFO);
                      }
                    },
                    child: Image.asset(
                      Img.get('pinterest.png'),
                      height: 25,
                    ),
                  ),
                  MaterialButton(
                    ...
                    onPressed: () {
                      if (controller.linkList.length < 9 &&
                          !controller.text.contains('twitter')) {
                        ...
                        CustomDialogs().showMessageDialog(
                            title: 'Alert',
                            description: 'Twitter Link already added',
                            type: DialogType.INFO);
                      }
                    },
              ...
              Row(
                ...
                children: [
                  MaterialButton(
                    ...
                    onPressed: () {
                      if (controller.linkList.length < 9 &&
                          !controller.text.contains('reddit')) {
                        ...
                        CustomDialogs().showMessageDialog(
                            title: 'Alert',
                            description: 'Reddit Link already added',
                            type: DialogType.INFO);
                      }
                    },
                    child: Image.asset(
                  ...
                  MaterialButton(
                    ...
                    onPressed: () {
                      if (controller.linkList.length < 9 &&
                          !controller.text.contains('quora')) {
                        ...
                        CustomDialogs().showMessageDialog(
                            title: 'Alert',
                            description: 'Quora Link already added',
                            type: DialogType.INFO);
                      }
                    },
                    child: Image.asset(
                  ...
                  MaterialButton(
                    ...
                    onPressed: () {
                      if (controller.linkList.length < 9 &&
                          !controller.text.contains('linkedin')) {
                        ...
                        CustomDialogs().showMessageDialog(
                            title: 'Alert',
                            description: 'LinkedIn Link already added',
                            type: DialogType.INFO);
                      }
                    },
                    child: Image.asset(
                      Img.get('linkedin_icon.png'),
                      height: 25,
                    ),
                  ),
                ],
        ...
        children: [
          ...
          customTextField(
              ...
              suffixIcon: Padding(
                ...
                child: Image.asset(Img.get(text == 'facebook'
                    ? 'facebook_icon.png'
                    : text == 'whatsapp'
                        ? 'whatsapp_icon.png'
                        : text == 'instagram'
