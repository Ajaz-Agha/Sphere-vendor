...
class VendorHiddenScreen extends GetView<VendorHiddenScreenController>{
  const VendorHiddenScreen({super.key});
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text('Please select for Active/Draft',style: heading1(color: AppColors.primary,fontSize: 17),),
                        ),
                        Row(
                          children: [
                            Expanded(
